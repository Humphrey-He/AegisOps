export const queryKeys = {
  ...
  taskDispatches: (scope: string) => ["taskDispatches", scope] as const,
  taskDispatch: (dispatchId: string) => ["taskDispatch", dispatchId] as const,
  ...
  backup: (backupId: string) => ["backup", backupId] as const,
  backupManifest: (backupId: string) => ["backupManifest", backupId] as const,
