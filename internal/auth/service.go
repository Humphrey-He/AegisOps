...
func seedPermissions(ctx context.Context, tx *gorm.DB) ([]model.Permission, error) {
	definitions := []model.Permission{
		...
		{Name: "Nginx Test", Code: "nginx.test", Resource: "nginx", Action: "test"},
		{Name: "Tasks View", Code: "tasks.view", Resource: "tasks", Action: "view"},
		{Name: "Tasks Create", Code: "tasks.create", Resource: "tasks", Action: "create"},
		{Name: "Tasks Dispatch", Code: "tasks.dispatch", Resource: "tasks", Action: "dispatch"},
		{Name: "Tasks Cancel", Code: "tasks.cancel", Resource: "tasks", Action: "cancel"},
		{Name: "Tasks Retry", Code: "tasks.retry", Resource: "tasks", Action: "retry"},
		{Name: "Audits View", Code: "audits.view", Resource: "audits", Action: "view"},
		{Name: "Hosts Test", Code: "hosts.test", Resource: "hosts", Action: "test"},
		{Name: "Hosts Operate", Code: "hosts.operate", Resource: "hosts", Action: "operate"},
		{Name: "Services Rollback", Code: "services.rollback", Resource: "services", Action: "rollback"},
		{Name: "Nginx Reload", Code: "nginx.reload", Resource: "nginx", Action: "reload"},
		{Name: "Nginx Publish", Code: "nginx.publish", Resource: "nginx", Action: "publish"},
		{Name: "Nginx Rollback", Code: "nginx.rollback", Resource: "nginx", Action: "rollback"},
		{Name: "Secrets Use", Code: "secrets.use", Resource: "secrets", Action: "use"},
		{Name: "Secrets Rotate", Code: "secrets.rotate", Resource: "secrets", Action: "rotate"},
		{Name: "Notifications Secret Manage", Code: "notifications.secret.manage", Resource: "notifications", Action: "secret_manage"},
		...
		{Name: "Exports View", Code: "exports.view", Resource: "exports", Action: "view"},
		{Name: "Exports Create", Code: "exports.create", Resource: "exports", Action: "create"},
		{Name: "Exports Download", Code: "exports.download", Resource: "exports", Action: "download"},
		{Name: "Exports Unmasked", Code: "exports.unmasked", Resource: "exports", Action: "unmasked"},
		{Name: "Backups View", Code: "backups.view", Resource: "backups", Action: "view"},
		{Name: "Backups Create", Code: "backups.create", Resource: "backups", Action: "create"},
		{Name: "Backups Download", Code: "backups.download", Resource: "backups", Action: "download"},
		{Name: "Backups Download Unmasked", Code: "backups.download.unmasked", Resource: "backups", Action: "download_unmasked"},
		{Name: "Scheduler View", Code: "scheduler.view", Resource: "scheduler", Action: "view"},
		{Name: "Scheduler Manage", Code: "scheduler.manage", Resource: "scheduler", Action: "manage"},
	}
